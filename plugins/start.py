...
async def delete_files(messages, client, k):
    ...
    await k.edit_text("<b><i>Yᴏᴜʀ Vɪᴅᴇᴏ / Fɪʟᴇ ɪs Sᴜᴄᴄᴇssғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ Dm @Kiranxer_Promo for buying Group ✅</i></b>")
